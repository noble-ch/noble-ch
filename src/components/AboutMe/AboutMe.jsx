						...
						<div
							...
							<div className="about-description">
								<div id="foo" unselectable="on" class="unselectable">
									<div />
                  <p>I'm a 21-year-old Computer Science and Engineering student at
									Adama Science and Technology University. I specialize in
									Full-stack Web Development, with expertise in Python, Django,
									JavaScript, React, and Java.<br/><br/>
                  As a detail-oriented problem
									solver, I thrive on tackling complex challenges and crafting
									innovative web solutions. I have a strong passion for staying
									up-to-date with the latest technologies and adapting quickly
									to industry trends.<br/><br/>
                   Collaboration is central to my approach,
									and I enjoy working with diverse teams to deliver high-quality
									projects. Fluent in English, Amharic, and Oromic, I value
									effective communication and connection with others.<br/><br/>
